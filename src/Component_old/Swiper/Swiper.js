...
class Swiper extends React.Component {
                ...
                style={[
                    {
                        ...
                        alignItems: "center",
                        backgroundColor: 'red', height: 300, width: 300
                    }
                ]}
    ...
    render() {
        Utils.nlog("gia tri item swiper", this.state.arrSwipeData)
        return (
            <View style={[this.props.style, { width: this.props.containerWidth, height: 300, backgroundColor: 'red', }]}>
                <FlatList
                    ref={flatList => {
...
Swiper.defaultProps = {
    ...
    leftButtonImage: Images.icBTBangcong,//leftArrow,
    rightButtonImage: Images.icBTBangcong,// rightArrow,
    showSwipeBtn: true,
