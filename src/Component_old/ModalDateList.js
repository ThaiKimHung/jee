        ...
        return (
            <View style={{
                ...
                <View style={[nstyles.nrow, { justifyContent: 'center', alignItems: 'center' }]}>
                    ...
                    <Text style={{ textAlign: 'center', fontSize: reText(14), lineHeight: 20, marginVertical: 8, fontWeight: 'bold', marginLeft: 8, color: colors.greenishTeal }}>
...
class ModalDateList extends PureComponent {
    constructor(props) {
        super(props);
        this._setTimeFC = Utils.ngetParam(this, "setTimeFC", () => { });
        this.options = Utils.ngetParam(this, "options", {});
        let defaultOptions = {
            // title: 'Chọn ngày',
            // textFrom: 'CHECK IN',
            textTo: 'CHECK OUT',
    ...
    async componentDidMount() {
        ...
        Utils.nlog('render DateList', this.optionsCus);
        //set default value
    ...
    _goback = async () => {
        ...
        Utils.nlog("gia tri date set goback", dateSelected, dateSelected2)

        await this._setTimeFC(moment(dateSelected.fullDate.toString()).format('MM/DD/YYYY'), moment(dateSelected2.fullDate.toString()).format('MM/DD/YYYY'));
        Utils.goback(this);
    }
    render() {
        this.loadLanguage();
