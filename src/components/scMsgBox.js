...
export default class scMsgBox extends React.PureComponent {
    ...
    constructor(props) {
        ...
        this.buttons = this.props.navigation.getParam('buttons', [{ text: 'OK', img: [], color: [], onPress: () => { } }]);
        this.isdelete = this.props.navigation.getParam('isdelete', false);
        this.goBack = this.props.navigation.getParam('goBack', false);
        this.dataMsgBox = this.props.navigation.getParam('dataMsgBox', {});
        this.disable = this.props.navigation.getParam('disable', false);
        this.colorButtonLeft = this.props.navigation.getParam('colorButtonLeft', null);
        this.colorButtonRight = this.props.navigation.getParam('colorButtonRight', null);
                                ...
                                this.buttons.length == 2 ?
                                    <View style={{ width: '40%' }}>
                                        ...
                                        <ButtonCom
                                            ...
                                            style={{
                                                backgroundColor: this.disable == true ? "#E2E2E2" : this.buttons[1].img ? "#FFBE68" : colors.colorBtnGray,
                                                backgroundColor1: this.disable == true ? "#E2E2E2" : this.buttons[1].img ? "#F5892A" : colors.colorBtnGray,
                                                color: this.buttons[1].img ? colors.white : colors.colorTextBack80
                                            }}
