    ...
    return (
        <View style={[nstyles.nstyles.ncontainer, { backgroundColor: `transparent`, width: Width(100), height: Height(100) }]}>
            ...
            <View style={{
                ...
                zIndex: 1,
                paddingVertical: 20,
                top: Height(18), left: 0, width: '100%', height: 'auto'
            }}>
                <View >
                    <View style={{
                        paddingVertical: 10,
...
class CalandaSingalComViTri extends Component {
    constructor(props) {
        super(props);
...
export default Utils.connectRedux(CalandaSingalComViTri, mapStateToProps, true)
