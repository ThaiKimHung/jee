...
class HeaderComStack extends Component {
    constructor(props) {
        super(props);
                        ...
                        onPress={onPressLeft}>
                        {
                            iconLeft && textleft ?
                                ...
                                <Image
                                    ...
                                    resizeMode={'cover'}
                                    style={{ width: 16, height: 16, borderRadius: 16, tintColor: "black" }}
                                />
                        }
                    </TouchableOpacity>
                    <View
...
export default Utils.connectRedux(HeaderComStack, mapStateToProps, true)
