            ...
            <View style={[{ height: this.state.editorHeight, }]}>
              ...
              <View style={[{ flexDirection: "row", }]}>
                <View style={{ justifyContent: "center", alignItems: 'center' }}>
                  <Image source={{ uri: props.avatar }} resizeMode='contain' style={nstyles.nAva35} />
                </View>
                <View style={{ borderRadius: 20, flexDirection: "row", justifyContent: "center", paddingVertical: 5, alignItems: 'center', maxHeight: Height(15), flex: 1 }}>
                  ...
                  <View style={{ flexDirection: "row", alignItems: "flex-end", marginRight: 10, marginBottom: 10, position: "absolute", right: 30 }}>
                    {state.inputText ? (
                      <TouchableOpacity style={{ paddingRight: 10 }} onPress={() => this._addComment()}>
                        <Image source={Images.ImageJee.icSent}
                          resizeMode='contain' style={nstyles.nIcon19} />
                      </TouchableOpacity>
                    ) : (null)}
                    {/* <TouchableOpacity style={{ paddingRight: 10 }} onPress={() => this.setState({ flagEmoji: !flagEmoji }, () => { this.toggleAnimationEmoji() })}>
                      <Image source={Images.ImageJee.icMatcuoi}
                        resizeMode='contain' style={nstyles.nIcon19} />
                    </TouchableOpacity> */}
                    <TouchableOpacity style={{ paddingRight: 10 }}
                      onPress={() => { this.props.image() }}>
                      <Image source={Images.ImageJee.icCamera}
