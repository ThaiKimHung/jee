...
class HeaderMeeting extends Component {
    constructor(props) {
        super(props);
        ...
        return (
            ...
            <View
                ...
                <View style={[nstyles.nrow, {
                    ...
                    {iconRight ?
                        <TouchableOpacity onPress={onPressRight} style={[{ paddingLeft: 20, paddingVertical: 5, paddingRight: 10 }, styTouchRight]}>
...
export default Utils.connectRedux(HeaderMeeting, mapStateToProps, true)
