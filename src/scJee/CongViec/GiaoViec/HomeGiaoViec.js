...
class HomeGiaoViec extends Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            _dateDk: moment().add(-6, 'months').format('DD/MM/YYYY'),
            ...
            showModal: false,
            sort: '',
            loai: 2, //1- cv tôi 2- tôi giao 3- theo dõi 
            checkLoadding: true
        };
        this.IdScreen = 'giaoviec' // name màn hình đặt lưu Golbal
    }
    ...
    _renderItem = ({ item, index }) => {
        ...
        return (
            <TouchableOpacity
                ...
                {index != this.state.dataCV.length - 1 ? (
                ...
                ) : <View style={{ paddingBottom: paddingBotX + 20 }} />}
            </TouchableOpacity >
        )
    }
        ...
        return (
            <View style={{ flex: 1 }}>
                <HeaderComStack onPressLeft={() => { Utils.goback(this, null) }}
                    nthis={this} title={RootLang.lang.JeeWork.danhsachcongviecdagiao}
                    count={this.props.count}
                />
                <View style={{ flex: 1, backgroundColor: "#F2F3F5" }}>
                    <View style={{ backgroundColor: colors.white, flex: 1 }}>
                        <View style={{ marginVertical: 10, flexDirection: "row", justifyContent: "space-between", paddingHorizontal: 20 }}>
                            <View style={{ backgroundColor: "#F2F3F5", borderRadius: 20, width: "90%" }}>
                                <View style={{ flexDirection: 'row', alignItems: 'center', }}>
                                    ...
                                    <TextInput
                                        ...
                                        onSubmitEditing={this.searchTitle}
                                        value={searchString}
                        ...
                        <View style={{ borderBottomWidth: 0.5, borderColor: colors.black_20_2, paddingBottom: 10 }}>
                        ...
                        <View style={{ flex: 1 }}>
                            ...
                            <TouchableOpacity onPress={() => {
                                Utils.goscreen(this.nthis ? this.nthis : this, "TaoGiaoViec", { callback: this.CallBackTaoCV })
                            }}
                                style={styles.create} >
                                <Text style={{ fontSize: reText(14), color: colors.colorJeeNew.colorBlueHome, fontWeight: 'bold' }}>{RootLang.lang.thongbaochung.giaocongviecmoi}</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
...
export default Utils.connectRedux(HomeGiaoViec, mapStateToProps, true)
