...
import HoatDong from './TaoCongViec/HoatDong';
import ChiTietCongViecQuyTrinh from './ChiTietCongViecQuyTrinh'

class TabCongViecChiTiet extends Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            index: 0,
            routes: [
                { key: 'ChiTiet', title: RootLang.lang.JeeWork.chitietcongviec, }, //Giữ tên cũ, hiện tại là cv được giao
                { key: 'HoatDong', title: RootLang.lang.JeeWork.hoatdong } //Công việc theo quy trình
            ],
            isRef: false,
        }
    }
    ...
    renderScene = ({ route }) => {
        switch (route.key) {
            case 'ChiTiet':
                return (
                    <ChiTietCongViecQuyTrinh nthis={this} />
                )
            case 'HoatDong':
                return (
                    <HoatDong nthis={this} trangchinh={true} />
                )
            default:
                return null;
        }
        ...
        return (
            <View style={[nstyles.ncontainer, { flex: 1, backgroundColor: colors.white }]}>
                <HeaderComStack
                    ...
                    nthis={this}
                    title={RootLang.lang.JeeWork.chitietcongviec}
...
export default Utils.connectRedux(TabCongViecChiTiet, mapStateToProps, true)