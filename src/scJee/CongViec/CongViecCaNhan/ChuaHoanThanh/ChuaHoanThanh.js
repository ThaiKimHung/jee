...
class ChuaHoanThanh extends Component {
    constructor(props) {
        super(props);
        ...
        this.IdScreen = 'canhan' // name màn hình đặt lưu Golbal
    }
                ...
                <View style={{ padding: 2, marginBottom: 5, flexDirection: 'row', }}>
                    <View style={{ justifyContent: 'center', alignItems: 'center', paddingHorizontal: 10 }}>
                        <FastImagePlaceholder
                            ...
                            source={{ uri: item.NguoiGiao[0]?.image ? item.NguoiGiao[0].image : item.avatar }}
                            resizeMode={"cover"}
...
export default Utils.connectRedux(ChuaHoanThanh, mapStateToProps, true)